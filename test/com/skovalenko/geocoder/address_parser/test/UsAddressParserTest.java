...
public class UsAddressParserTest {
    ...
    private static final ParsedUsAddress PARSED_ADDRESS[] = {
            new ParsedUsAddress("13101", null, "JAMES E CASEY", "AVE", null, null, null, "ENGLEWOOD", null, "80112", null),
    ...
    private static final UnparsedAddress RAW_ADDRESS[] = { new UnparsedAddress("13101 James E Casey Ave", "Englewood", "80112"),
            new UnparsedAddress("665 W Chestnut St Apt 1", "Washington", "15301"), new UnparsedAddress("55 East Buffalo Church Rd", "Washingtoin", "15301"),
            new UnparsedAddress("100 Robinson Ctr Dr #K10", "Pittsburgh", "15205"), new UnparsedAddress("300 Cedar Blvd Ste B-4", "Pittsburgh", "15228"),
            new UnparsedAddress("729- 731 N. Shenango Rd..", "Beaver Falls", "15010"),
            new UnparsedAddress("6748 N. Ashland Ave. - Apt # 206", "Chicago", "60626"), new UnparsedAddress("6253 North Lakewood Ave", "Chicago", "60660"),
            new UnparsedAddress("3632 -36 N Cicero Ave", "Chicago", "60641"), new UnparsedAddress("536 1/2 Michigan St", "Evanston", "60201"),
            new UnparsedAddress("4709 W Golf Rd Ste. 500A", "Skokie", "60076"), new UnparsedAddress("1A1121 Salmonberry st ", " Meadow Lakes", " 99654"),
            new UnparsedAddress("881 Route 83", "Franklin", "60106"), new UnparsedAddress("1019 Rt 519 Building 4", "Eighty Four", "15330"),
            new UnparsedAddress("1019 Rte 519 Bld 4", "Eighty Four", "15330"), new UnparsedAddress("57A Commerce Blvd. ", " Washington ", " 15301"),
            new UnparsedAddress("10-B Commerce Blvd. ", " Washington ", " 15301 "), new UnparsedAddress("14Bis Commerce Blvd. ", " Washington ", " 15301 "),
            new UnparsedAddress("435-IV Commerce Blvd. ", " Washington ", " 15301"), new UnparsedAddress("D1 Commerce Blvd. ", " Washington ", " 15301"),
            new UnparsedAddress("315A Commerce Blvd. ", " Washington ", " 15301"), new UnparsedAddress("N50W5200 Commerce Blvd. ", " Washington ", " 15301"),
            new UnparsedAddress("2C200 Commerce Blvd. ", " Washington ", " 15301"), new UnparsedAddress("12 1/4 A Commerce Blvd. ", " Washington ", " 15301"),
            new UnparsedAddress("865 Indian Service Route 10", "Zuni Pueblo", "87327"), new UnparsedAddress("5629 Route 9H and 23", "Claverack", "12534"),
            new UnparsedAddress("12 Route 5059 CR 474", "Sweetwater", "86514"), new UnparsedAddress("506 Route of the Olympic Torch", "Westwood", "96130"),
            new UnparsedAddress("10 Route 7 To 9/5", "Harrison", "26301"), new UnparsedAddress("499 Route 369 Woodward Twp", "Woodward", "17744"),
            new UnparsedAddress("230 Tower", "Haines", "99827"), new UnparsedAddress("3812 S Tower", "Naco", "85603"),
            new UnparsedAddress("315 West", "Decatur", "72722"), new UnparsedAddress("3360 East", "Montgomery", "36110"),
            new UnparsedAddress("38 Soldiers Rte", "Spanish Fort", "36527"), new UnparsedAddress("2569 Reveres Route", "Granite City", "62040"),
            new UnparsedAddress("22 Park Line", "Park Ridge", "60068"), new UnparsedAddress("4151 Garden", "Western Springs", "60558"),
            new UnparsedAddress("534 Park Plaine", "Park Ridge", "60068"), new UnparsedAddress("88 Boulevard", "Cornwall On Hud", "12520"),
            new UnparsedAddress("7 Rue De Vin", "Marlboro", "12542"), new UnparsedAddress("128 Bridge", "Monticello", "12701"),
            new UnparsedAddress("380 Boulevard", "Kingston", "12401"), new UnparsedAddress("51 Forest", "Monroe", "10950"),
            new UnparsedAddress("195 Lake Louise Marie Roa", "Rock Hill", "12775"), new UnparsedAddress("45 Avenue A", "Cornwall On Hud", "12520"),
            new UnparsedAddress("1023 Summit Woods", "New Windsor", "12553"), new UnparsedAddress("46 St.Andrews", "Walden", "12586"),
            new UnparsedAddress("181 S Villa", "Elmhurst", "60126"), new UnparsedAddress("229 R0Ute 202", "Pomona", "10970"),
            new UnparsedAddress("4901 W. Irving Park", "Chicago", "60641"),
            // numeric street names
            new UnparsedAddress("549 W 135th St", "New York", "10031"), new UnparsedAddress("791 Five Forks Trickum Rd", "Lawrenceville", "30045"),
            new UnparsedAddress("8193 Thirteen Bridges Rd", "Enfield", "27823"), new UnparsedAddress("75 W Eleventh St", "Winnsboro Mills", "29180"),
            new UnparsedAddress("38 S Nine Dr", "Sawgrass", "32082"), new UnparsedAddress("6562 E 1300 Rd", " Chenoa", "61726"),
