...
public class UsAddressParser {
    ...
    private static ParsedUsAddress parseAddressLine(String address) {
        ...
        parsedAddress.setStreetNumber(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_STREET_NUMBER));
        parsedAddress.setStreetPreDir(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_STREET_PREDIR));
        parsedAddress.setStreetName(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_STREET_NAME));
        parsedAddress.setStreetType(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_STREET_TYPE));
        parsedAddress.setStreetPostDir(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_STREET_POSTDIR));
        parsedAddress.setSubUnitNumber(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_SU_NUMBER));
        parsedAddress.setSubUnitName(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_SU_TYPE));
        parsedAddress.setCity(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_CITY));
        parsedAddress.setState(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_STATE));
        parsedAddress.setZip(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_ZIP));
        parsedAddress.setZip4(ParserUtilities.getValueFromTokens(addressTokens, HintTypes.HINT_ZIP4));
    ...
    private static ParsedUsAddress standardize(ParsedUsAddress address) {
        ...
        if (standardDir != null) address.setStreetPreDir(standardDir);
        String streetType = UsAddressParserDataStrings.STREET_TYPE.get(address.getStreetType());
        if (streetType != null) address.setStreetType(streetType);
        return address;
    }
}
