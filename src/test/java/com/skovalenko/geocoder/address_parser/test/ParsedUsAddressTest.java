...
public class ParsedUsAddressTest {
    ...
    public void testParsedUsAddress() throws Exception {
        UsAddressTestBase.checkNoNulls(new ParsedUsAddress(null, null, null, null, null, null, null, null, null, null, null));
        UsAddressTestBase.checkNoNulls(new ParsedUsAddress(null, null, null, null, null, null, null));
        UsAddressTestBase.checkNoNulls(new ParsedUsAddress());
        ParsedUsAddress pa = new ParsedUsAddress("streetNumber", "streetPreDir", "streetName", "streetType", "streetPostDir", "subUnitName", "subUnitNumber",
                "city", "state", "zip", "zip4");
        ...
        pa = new ParsedUsAddress("streetNumber", "streetPreDir", "streetName", "streetType", "streetPostDir", "subUnitName", "subUnitNumber");
        // ensure order of constructor agruments
        assertTrue("Streetname".equalsIgnoreCase(pa.getStreetName()));
        assertTrue("Streetnumber".equalsIgnoreCase(pa.getStreetNumber()));
        assertTrue("Streetpostdir".equalsIgnoreCase(pa.getStreetPostDir()));
